        ...
        return <div className='sh-home'>
            <div className='sh-hero'>
                <div className='sh-hero-wrapper'>
                    <div className='sh-hero-title'>The future of intelligent hospitality and connected workplace d&eacute;ploiement direct &agrave; partir de Visual Studio demo v0.1.</div>
